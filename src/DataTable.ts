...
@Directive({
    selector: 'table[jtcData]',
    exportAs: 'jtcDataTable'
})

export class DataTable implements OnChanges, DoCheck {

    @Input("jtcData") public inputData:any[] = [];

    private sortBy = "";
    private sortOrder = "asc";

    @Input("jtcRowsOnPage") public rowsOnPage = 1000;
    @Input("jtcActivePage") public activePage = 1;
