...
var DefaultSorter = (function () {
    function DefaultSorter(jtcTable) {
        var _this = this;
        this.jtcTable = jtcTable;
        this.isSortedByMeAsc = false;
        this.isSortedByMeDesc = false;
        jtcTable.onSortChange.subscribe(function (event) {
    ...
    DefaultSorter.prototype.sort = function () {
        if (this.isSortedByMeAsc) {
            this.jtcTable.setSort(this.sortBy, "desc");
        }
        else {
            this.jtcTable.setSort(this.sortBy, "asc");
        }
    };
    __decorate([
        core_1.Input("by"), 
